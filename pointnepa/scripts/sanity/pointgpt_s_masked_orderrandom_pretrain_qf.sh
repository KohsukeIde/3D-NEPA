...
export CONFIG_PATH="cfgs/PointGPT-S/pretrain_orderrandom.yaml"
export EXP_NAME="pgpt_s_masked_ordrand_e300"
...
echo "=== PointGPT-S mask0.7 order-randomized pretrain ==="
echo "date=$(date -Is)"
echo "host=$(hostname)"
...
bash "${WORKDIR}/pointnepa/scripts/local/pointgpt_s_nomask_orderrandom_full.sh"

echo "[done] PointGPT-S mask0.7 order-randomized pretrain"
