...
export CONFIG_PATH="cfgs/PointGPT-S/pretrain.yaml"
export EXP_NAME="pgpt_s_masked_causal_e300"
...
echo "=== PointGPT-S mask0.7 causal-order pretrain ==="
echo "date=$(date -Is)"
echo "host=$(hostname)"
