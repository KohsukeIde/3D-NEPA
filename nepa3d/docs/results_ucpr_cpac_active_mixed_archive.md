...
| Tag | CKPT | Query -> Gallery | Split | max_files | R@1 | R@5 | R@10 | MRR (=single-positive mAP) | Note |
|---|---|---|---|---:|---:|---:|---:|---:|---|
...
| Pair | NoDual R@1/R@5/R@10/MRR | DualMask R@1/R@5/R@10/MRR |
|---|---|---|
...
| Model | Base R@1/MRR | `ablate_point_xyz` R@1/MRR | `ablate_point_dist` R@1/MRR |
|---|---|---|---|
...
| Pair | Pooling | R@1 | R@5 | R@10 | MRR (=single-positive mAP) |
|---|---|---:|---:|---:|---:|
...
| Setting | R@1 | R@5 | R@10 | MRR (=single-positive mAP) |
|---|---:|---:|---:|---:|
...
| UCPR `mesh->udfgrid` MRR (`mean_a`) | NEPA QA+dualmask | 0.04112 +- 0.00027 |
| UCPR `mesh->udfgrid` MRR (`mean_a`) | MAE | 0.05010 +- 0.00072 |
...
| UCPR `mesh->pointcloud_noray` MRR (`mean_a`) | NEPA QA+dualmask | 0.04568 +- 0.00043 |
| UCPR `mesh->pointcloud_noray` MRR (`mean_a`) | MAE | 0.05446 +- 0.00089 |
