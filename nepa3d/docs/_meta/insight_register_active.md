...
| I014 | PointGPT sidecar | PointGPT / pointNEPA ScanObjectNN matrix | PointGPT/pointNEPA sidecar results are active comparison context and protocol sanity, not PatchNEPA benchmark headline values. | sidecar | `pointnepa/docs/results_scanobjectnn_active.md`, `nepa3d/docs/results_index.md` |
