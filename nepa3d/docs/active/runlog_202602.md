...
### 22.4 Point-MAE BS64 extfix retries (`retry4` -> `retry5`)
...
`retry5` run set (current active):

- `logs/sanity/pointmae_scratch/*pointmae_scan3_scratch_bs64_extfix_retry5_20260227_220742*`
- scheduler:
  - scratch: `99275` (`obj_bg`), `99277` (`obj_only`), `99279` (`pb_t50_rs`) are running
  - test: `99276`, `99278`, `99280` are dependency-held (`afterok` on corresponding scratch jobs)
- early runtime check from logs:
