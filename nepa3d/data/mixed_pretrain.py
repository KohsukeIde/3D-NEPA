...
def build_mixed_pretrain(
    ...
    sequence_mode: str = "block",
    event_order_mode: str = "morton",
    ray_order_mode: str = "theta_phi",
    ray_anchor_miss_t: float = 4.0,
    ray_view_tol: float = 1e-6,
    include_pt_grad: bool = False,
    pt_grad_mode: str = "raw",
    pt_grad_eps: float = 1e-3,
    pt_grad_clip: float = 10.0,
    pt_grad_orient: str = "none",
    include_ray_unc: bool = False,
    ray_unc_k: int = 8,
    ray_unc_mode: str = "normal_var",
    voxel_grid: int = 64,
    voxel_dilate: int = 1,
