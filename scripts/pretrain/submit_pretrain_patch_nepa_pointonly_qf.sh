...
if [[ "${PT_SAMPLE_MODE}" == "rfps_cached" && "${ALLOW_RFPS_CACHED}" != "1" ]]; then
  echo "WARN: PT_SAMPLE_MODE=rfps_cached requested, policy defaults to non-cached RFPS; overriding to PT_SAMPLE_MODE=rfps."
  PT_SAMPLE_MODE="rfps"
fi
