...
PointGPT / pointNEPA local launchers moved to the sidecar workspace:
...
- `pointnepa/scripts/sanity/pointgpt_*_local_*.sh` are compatibility shims only;
  maintained PointGPT / pointNEPA local entrypoints live under
