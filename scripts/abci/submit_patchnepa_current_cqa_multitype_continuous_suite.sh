...
SCRIPT="${ROOT_DIR}/scripts/analysis/nepa3d_cqa_multitype_continuous_suite_qg.sh"
DEFAULT_CKPT="runs/cqa/patchnepa_cqa_distnorm_continuous_20260323/cqa_distnorm_continuous_independent_g2_s10000/ckpt_final.pt"

CKPT="${CKPT:-${DEFAULT_CKPT}}"
RUN_SET="${RUN_SET:-patchnepa_cqa_multitype_continuous_suite_$(date +%Y%m%d_%H%M%S)}"
RUN_TAG="${RUN_TAG:-cqa_distnorm_continuous_suite}"
...
RESULTS_ROOT="${RESULTS_ROOT:-${ROOT_DIR}/results/cqa_multitype/${RUN_SET}}"
