...
export RUN_SET="${RUN_SET:-patchnepa_cqa_v2_distnorm_unsigned_trainmesh_mixture30ep_${STAMP}}"
export RUN_SLUG="${RUN_SLUG:-cqa_v2_distnorm_unsigned_trainmesh_mixture30ep}"
export TRAIN_RUN_TAG="${TRAIN_RUN_TAG:-cqa_v2_distnorm_unsigned_trainmesh_mixture30ep_independent_g2_e30}"
...
export SAMPLING_PROTOCOL="${SAMPLING_PROTOCOL:-mixture}"
...
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,cqa_v2,distnorm_unsigned,trainmesh_common,mixture,shared_head,e30}"
