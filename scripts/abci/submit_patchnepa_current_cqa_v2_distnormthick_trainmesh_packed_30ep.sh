...
export RUN_SET="${RUN_SET:-patchnepa_cqa_v2_distnormthick_trainmesh_packed30ep_${STAMP}}"
export RUN_SLUG="${RUN_SLUG:-cqa_v2_distnormthick_trainmesh_packed30ep}"
export TRAIN_RUN_TAG="${TRAIN_RUN_TAG:-cqa_v2_distnormthick_trainmesh_packed30ep_independent_g2_e30}"
export MIX_CONFIG="${MIX_CONFIG:-nepa3d/configs/shapenet_unpaired_mix_v2_cqa_v2_dist_norm_thick_trainmesh_common.yaml}"
...
export HEAD_MODE="${HEAD_MODE:-shared}"
...
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,cqa_v2,distnormthick,trainmesh_common,packed,shared_head,e30}"
