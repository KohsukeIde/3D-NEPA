...
export RUN_SET="${RUN_SET:-patchnepa_cqa_v2_distnorm_unsigned_prefixlm_full_${STAMP}}"
export RUN_SLUG="${RUN_SLUG:-cqa_v2_distnorm_unsigned_prefixlm_full_e100}"
export TRAIN_RUN_TAG="${TRAIN_RUN_TAG:-cqa_v2_distnorm_unsigned_prefixlm_independent_g2_e100}"
...
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,cqa_v2,distnorm_unsigned,prefixlm,independent,full100}"
