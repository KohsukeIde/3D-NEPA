...
export RUN_SET="${RUN_SET:-patchnepa_cqa_v2_distnorm_unsigned_encdec_d12_fullq_${STAMP}}"
export TRAIN_RUN_TAG="${TRAIN_RUN_TAG:-cqa_v2_distnorm_unsigned_encdec_independent_d12_fullq_g2_s10000}"
...
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,cqa_v2,distnorm_unsigned,encdec,d12,full_q,independent}"
