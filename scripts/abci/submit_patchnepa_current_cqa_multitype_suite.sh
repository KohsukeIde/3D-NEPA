...
SCRIPT="${ROOT_DIR}/scripts/analysis/nepa3d_cqa_multitype_suite_qg.sh"
...
RUN_SET="${RUN_SET:-patchnepa_cqa_multitype_suite_$(date +%Y%m%d_%H%M%S)}"
RUN_TAG="${RUN_TAG:-cqa_v2_distnorm_unsigned_suite}"
