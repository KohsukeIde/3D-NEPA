...
export EVAL_QUERY_ORDER="${EVAL_QUERY_ORDER:-${QUERY_ORDER}}"
...
echo "[abci-cqa-pretrain] query_interface_mode=${QUERY_INTERFACE_MODE}"
echo "[abci-cqa-pretrain] query_order=${QUERY_ORDER} eval_query_order=${EVAL_QUERY_ORDER}"
