...
RUN_SET="${RUN_SET:-patchnepa_cqa_distthick_valid_shared_$(date +%Y%m%d_%H%M%S)}"
RUN_TAG="${RUN_TAG:-cqa_distthick_valid_independent_g2_s10000}"
...
export SAVE_DIR
export LOG_ROOT
export MIX_CONFIG="${MIX_CONFIG:-nepa3d/configs/shapenet_unpaired_mix_v2_cqa_dist_thick_valid_qbin.yaml}"
...
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,distthick_valid,independent}"
