...
RUN_SET="${RUN_SET:-patchnepa_cqa_v2_distnorm_unsigned_udfdist_completion_$(date +%Y%m%d_%H%M%S)}"
RUN_TAG="${RUN_TAG:-cqa_v2_distnorm_unsigned_udfdist_completion_grid12}"
