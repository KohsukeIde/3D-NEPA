...
export RUN_SET="${RUN_SET:-patchnepa_cqa_v2_distnorm_unsigned_trainmesh_packed30ep_${STAMP}}"
export RUN_SLUG="${RUN_SLUG:-cqa_v2_distnorm_unsigned_trainmesh_packed30ep}"
export TRAIN_RUN_TAG="${TRAIN_RUN_TAG:-cqa_v2_distnorm_unsigned_trainmesh_packed30ep_independent_g2_e30}"
...
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,cqa_v2,distnorm_unsigned,trainmesh_common,packed,shared_head,e30}"
