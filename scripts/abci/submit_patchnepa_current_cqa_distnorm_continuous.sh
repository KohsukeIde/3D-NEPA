...
LOSS_EMA_MOMENTUM="${LOSS_EMA_MOMENTUM:-0.99}" LOSS_EMA_EPS="${LOSS_EMA_EPS:-1e-6}" \
LOSS_WEIGHT_DISTANCE="${LOSS_WEIGHT_DISTANCE:-1.0}" LOSS_WEIGHT_AO="${LOSS_WEIGHT_AO:-1.0}" \
