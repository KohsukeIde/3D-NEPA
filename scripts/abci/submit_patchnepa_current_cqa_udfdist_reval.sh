...
export RUN_SET="${RUN_SET:-patchnepa_cqa_udfdist_worldv3_$(date +%Y%m%d_%H%M%S)}"
export RUN_TAG="${RUN_TAG:-cqa_udfdist_worldv3_g2_s2000}"
...
export WANDB_PROJECT="${WANDB_PROJECT:-patchnepa-cqa-reval}"
export WANDB_TAGS="${WANDB_TAGS:-abci,cqa,reval,udf_distance,world_v3}"
